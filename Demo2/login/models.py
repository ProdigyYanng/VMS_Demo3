...
class Car_Info(models.Model):  # 车辆信息表
...
class Car_Failure_Log(models.Model):  # 故障记录表
...
class Travel_Log(models.Model):  # 行驶记录表
...
class Site_Info(models.Model):  # 场地信息表
...
class Station_Info(models.Model):  # 站点信息表
